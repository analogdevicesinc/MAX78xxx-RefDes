 ...
 */
/*************************************************************************************************/
static void lctrExecAction(lctrConnCtx_t *pCtx, uint8_t proc, uint8_t act)
{
...
static void lctrNotifyHostReadRemoteFeatCnf(lctrConnCtx_t *pCtx, uint8_t status)
{
  ...
  evt.hdr.event        = LL_READ_REMOTE_FEAT_CNF;
...
static void lctrNotifyHostReject(lctrConnCtx_t *pCtx, uint8_t proc)
{
  ...
  reason = LL_ERROR_CODE_UNSUPPORTED_REMOTE_FEATURE;
