...
enum
{
  HIDAPP_REMOTE_PLAY_BTN,
  HIDAPP_REMOTE_PAUSE_BTN,
...
static void hidAppTestCycleButton(void)
{
  ...
  {
  case HIDAPP_REMOTE_PLAY_BTN:
    APP_TRACE_INFO0("HidApp Test Button: Remote Play");
    break;
  case HIDAPP_REMOTE_PAUSE_BTN:
    APP_TRACE_INFO0("HidApp Test Button: Remote Pause");
    break;
