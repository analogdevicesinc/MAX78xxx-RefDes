...
void WdxsHandlerInit(wsfHandlerId_t handlerId)
{
  ...
  WDXS_RamMediaCtrl.pageSize = 1;
  WDXS_RamMediaCtrl.init = NULL;
  WDXS_RamMediaCtrl.erase = WdxsRamErase;
  WDXS_RamMediaCtrl.read = WdxsRamRead;
  WDXS_RamMediaCtrl.write = WdxsRamWrite;
  WDXS_RamMediaCtrl.handleCmd = NULL;
