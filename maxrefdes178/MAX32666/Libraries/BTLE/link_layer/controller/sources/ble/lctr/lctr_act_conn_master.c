...
{
  uint32_t interMinUsec, interMaxUsec, durUsec, connIntervalUsec;
  ...
  interMinUsec = LCTR_CONN_IND_US(pCtx->connUpdSpec.connIntervalMin);
  interMaxUsec = LCTR_CONN_IND_US(pCtx->connUpdSpec.connIntervalMax);
