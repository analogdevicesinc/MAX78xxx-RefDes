...
{
  static lmgrAdvParam_t defAdvParam;
  defAdvParam.advInterMin    = 0x0800;
  defAdvParam.advInterMax    = 0x0800;
  defAdvParam.advType        = LL_ADV_CONN_UNDIRECT;
  defAdvParam.ownAddrType    = LL_ADDR_PUBLIC;
  defAdvParam.peerAddrType   = LL_ADDR_PUBLIC;
  defAdvParam.advChanMap     = LL_ADV_CHAN_ALL;
  defAdvParam.advFiltPolicy  = LL_ADV_FILTER_NONE;
