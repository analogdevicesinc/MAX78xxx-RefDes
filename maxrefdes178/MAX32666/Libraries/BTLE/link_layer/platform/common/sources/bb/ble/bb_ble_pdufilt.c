 ...
 */
/*************************************************************************************************/
static uint8_t bbBlePduFiltResolvePeer(bool_t peerAddrResEna, bool_t forceRes,
 ...
 */
/*************************************************************************************************/
bool_t bbBlePduFiltMatchPeer(bool_t addrMatchEna, bool_t idAddrRand, uint64_t idAddr,
 ...
 */
/*************************************************************************************************/
bool_t bbBlePduFiltWhiteList(bool_t peerWhiteListEna, bool_t peerIdAddrRand,
                                           uint64_t peerIdAddr)
{
  if (peerWhiteListEna)
  {
 ...
 */
/*************************************************************************************************/
uint8_t bbBlePduFiltResolveLocal(bool_t localAddrResEna, bool_t forceRes,
 ...
 */
/*************************************************************************************************/
bool_t bbBlePduFiltMatchLocal(bool_t addrMatchEna, bool_t idAddrRand, uint64_t idAddr,
                                            bool_t addrMatchRand, uint64_t addrMatch)
{
  if (addrMatchEna)
  {
                         ...
                         bool_t forceRes, bbBlePduFiltResults_t *pFiltResults)
{
  bool_t   peerAddrRand;
  uint64_t peerAddr;
  uint8_t result, pduType, pduLen, matchResult;
  ...
  pduType = pBuf[0] & LL_ADV_HDR_TYPE_MSK;
  pduLen  = pBuf[1] & LL_ADV_HDR_LEN_MSK;
  ...
  peerAddrRand = ((pBuf[0] >> BB_ADV_HDR_TX_ADD_SHIFT) & 1);
  peerAddr     = BstreamToBda64(pBuf + LL_ADV_HDR_LEN);
  ...
  matchResult = WSF_MAX(bbBlePduFiltMatchPeer(BB_BLE_PDU_FILT_FLAG_IS_SET(pFiltParams, PEER_ADDR_MATCH_ENA),
                                                      pFiltResults->peerIdAddrRand,
                                                      pFiltResults->peerIdAddr,
 ...
 */
/*************************************************************************************************/
void BbBlePduFiltResultsGetPeerIdAddr(const bbBlePduFiltResults_t *pFiltResults, uint64_t *pPeerIdAddr, uint8_t *pPeerIdAddrType)
{
 ...
 */
/*************************************************************************************************/
void BbBlePduFiltResultsGetPeerRpa(const bbBlePduFiltResults_t *pFiltResults, uint64_t *pPeerRpa)
{
  *pPeerRpa = 0;
  if ((pFiltResults->peerIdAddrRand != pFiltResults->peerAddrRand) ||
      (pFiltResults->peerIdAddr     != pFiltResults->peerAddr))
