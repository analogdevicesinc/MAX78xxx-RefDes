...
/*! Default payload length for WDX FTD */
#ifndef WDX_FTD_ATT_DEFAULT_PAYLOAD_LEN
#define WDX_FTD_ATT_DEFAULT_PAYLOAD_LEN     ATT_DEFAULT_PAYLOAD_LEN
#endif
...
static const attsAttr_t wdxsList[] =
{
  ...
  /* WDX File Transfer Data Characteristic Value */
  {
    ...
    (uint8_t *) wdxsValFtd,
    (uint16_t *) &wdxsLenFtd,
    WDX_FTD_ATT_DEFAULT_PAYLOAD_LEN,
    (ATTS_SET_UUID_128 | ATTS_SET_VARIABLE_LEN | ATTS_SET_WRITE_CBACK),
    WDXS_SEC_PERMIT_WRITE
  },
  /* WDX File Transfer Data CCCD */
