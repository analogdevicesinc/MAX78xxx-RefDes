 ...
 */
/*************************************************************************************************/
static dmSecKey_t *tagGetPeerKey(dmEvt_t *pMsg)
{
...
/*************************************************************************************************/
/*!
 *  \brief  Handle pairing complete or add device to resolving list indication.
 *
 *  \param  pMsg    Pointer to DM callback event message.
 *
 *  \return None.
...
static void tagSecPairCmpl(dmEvt_t *pMsg)
{
  ...
  /* if peer key found */
  if ((pPeerKey = tagGetPeerKey(pMsg)) != NULL)
  {
...
void TagStart(void)
{
  ...
  /* Initialize the Flash File Media */
  WdxsFlashMediaInit();
