...
static void cyclingSendCyclingSpeedMeasurement(dmConnId_t connId)
{
  if (AttsCccEnabled(connId, CYCLING_CSCS_CSM_CCC_IDX))
  {
    ...
    CscpsSetParameter(CSCP_SM_PARAM_WHEEL_REVOLUTIONS, 1);
    CscpsSetParameter(CSCP_SM_PARAM_LAST_WHEEL_EVT_TIME, 2);
    CscpsSetParameter(CSCP_SM_PARAM_CRANK_REVOLUTIONS, 1);
    CscpsSetParameter(CSCP_SM_PARAM_LAST_CRANK_TIME, 2);
...
static void cyclingSendCyclingPowerMeasurement(dmConnId_t connId)
{
  if (AttsCccEnabled(connId, CYCLING_CPS_CPM_CCC_IDX))
  {
    ...
    CppsSetParameter(CPP_PM_PARAM_LAST_CRANK_TIME, 3);
    CppsSetParameter(CPP_PM_PARAM_ACCUMULATED_TORQUE, 4);
    CppsSetParameter(CPP_PM_PARAM_WHEEL_REVOLUTIONS, 5);
    CppsSetParameter(CPP_PM_PARAM_LAST_WHEEL_REV_TIME, 6);
    CppsSetParameter(CPP_PM_PARAM_CRANK_REVOLUTIONS, 7);
    CppsSetParameter(CPP_PM_PARAM_LAST_CRANK_TIME, 8);
