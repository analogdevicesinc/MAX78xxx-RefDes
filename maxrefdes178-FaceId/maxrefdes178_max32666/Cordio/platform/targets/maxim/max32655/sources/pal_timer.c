...
#endif
{
  ...
  /* Check hardware status */
  PAL_TIMER_CHECK(PAL_SLEEP_TMR->intfl);
...
void PalTimerSleep(uint32_t expUsec)
{
  ...
  MXC_TMR_SetCompare(PAL_SLEEP_TMR, ((IBRO_FREQ/100) * expUsec)/10000); /* 7.3728 MHz clock */
