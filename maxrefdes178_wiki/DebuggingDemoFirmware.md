...
* ### MAXDAP-TYPE-C
    Insert the MAXDAP-TYPE-C into the MAXREFDES178 second debug channel.
    The MAXDAP-TYPE-C and the MAXREFDES178 cube camera lens should face **opposite** directions.
...
2. Select **MAX78000 Video** or **MAX78000 Audio** target with the button ‘Y’.
